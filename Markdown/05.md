...
接下来是`[事件名称]`，在Vue.js框架中，我们可注册的事件基本上是与HTML文档所支持的DOM 准事件一一对应的，只是名称有些许不同而已。并且在通常情况下，读者只需将 DOM 事件名称中的“on”前缀去掉，就得到了相关事件在Vue.js架中的对应名称了，在表5-1中，我们列出了一些在项目实践中常用的DOM事件及其在Vue.j 框架中的对应名称：
